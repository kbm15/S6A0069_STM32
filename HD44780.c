/**
  ...
  * fixed and ported to STM32L1 by Arturo Hermosa
  * @date    15_May-2019
  ******************************************************************************
  * @attention
  *
...
{
  HAL_GPIO_WritePin(LCDControlPort, LCD_Enable, GPIO_PIN_SET);
  HAL_Delay(2);
  HAL_GPIO_WritePin(LCDControlPort, LCD_Enable, GPIO_PIN_RESET);
}
